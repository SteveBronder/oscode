        ...
        {std::complex<double>(0, 1) * d1(1 - 1, 0),
         ...
         -std::complex<double>(0, 1 / 8) *
             (8.0 * d1(1 - 1, 1) * gs(0) * std::pow(ws(0), 3) -
              ...
              10.0 * d1(1 - 1, 0) * d2(1 - 1, 0) * ws(0) +
              9.0 * std::pow(d1(1 - 1, 0), 3)) /
             std::pow(ws(0), 4),
         0.0}};
  }
  virtual eigen_vec_c<4>
    ...
    return eigen_vec_c<4>{
        {std::complex<double>(0, 1) * ws(0),
         ...
         std::complex<double>(0, 1.0 / 8.0) *
             ...
             (ws(0) * ws(0) * ws(0)),
         (d2(1 - 1, 0) * ws(0) * ws(0) +
          2.0 * d2(1 - 1, 1) * (ws(0) * ws(0) * ws(0)) -
          6.0 * d1(1 - 1, 0) * d2(1 - 1, 0) * ws(0) +
          6.0 * (d1(1 - 1, 0) * d1(1 - 1, 0) * d1(1 - 1, 0)) -
          4.0 * ((gs(0) * gs(0)) + d1(1 - 1, 1)) * ws(0) * ws(0) *
              d1(1 - 1, 0) +
        ...
        {std::complex<double>(0, 1) * ws(5),
         ...
         std::complex<double>(0, 1.0 / 8.0) *
             (-4.0 * (gs(5) * gs(5)) * (ws(5) * ws(5)) -
              4.0 * d1(6 - 1, 1) * (ws(5) * ws(5)) -
              2.0 * d2(6 - 1, 0) * ws(5) +
              3.0 * (d1(6 - 1, 0) * d1(6 - 1, 0))) /
             (ws(5) * ws(5) * ws(5)),
         (d2(6 - 1, 0) * (ws(5) * ws(5)) +
          2.0 * d2(6 - 1, 1) * (ws(5) * ws(5) * ws(5)) -
          6.0 * d1(6 - 1, 0) * d2(6 - 1, 0) * ws(5) +
          6.0 * (d1(6 - 1, 0) * d1(6 - 1, 0) * d1(6 - 1, 0)) -
          4.0 * ((gs(5) * gs(5)) + d1(6 - 1, 1)) * (ws(5) * ws(5)) *
              d1(6 - 1, 0) +
    ...
    std::complex<double> s3 =
        (1 / 4.0 *
             (gs(5) * gs(5) / (ws(5) * ws(5)) -
              gs(0) * gs(0) / (ws(0) * ws(0))) +
         1 / 4.0 *
             (d1(6 - 1, 1) / (ws(5) * ws(5)) - d1(1 - 1, 1) / (ws(0) * ws(0))) -
         3 / 16.0 *
