...
RKSolver(de_system &de_sys) {
  ...
  butcher_a4 << 0.172673164646011428100, 0, 0,
  ...
  dense_b5 << 0.2089555395, 0., 0.7699501023, 0.009438629906,
  ...
  butcher_c4 << 0, 0.172673164646011428100, 0.827326835353988571900,
      1;
  P_dense << 1., -2.48711376, 2.42525041, -0.82538093, 0., 0., 0., 0.,
